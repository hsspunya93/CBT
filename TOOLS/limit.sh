#!/bin/bash
cd
wget -q -O /usr/local/sbin/quota "https://raw.githubusercontent.com/hsspunya93/CBT/main/TOOLS/quota"
chmod +x /usr/local/sbin/quota
cd /usr/local/sbin/
sed -i 's/\r//' quota
clear
cd
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/hsspunya93/CBT/main/TOOLS/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
clear
wget -q -O /usr/bin/limit-ip-ssh "https://raw.githubusercontent.com/hsspunya93/CBT/main/TOOLS/limit-ip-ssh"
chmod +x /usr/bin/*
cd /usr/bin
