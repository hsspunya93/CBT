...
while true; do
    ...
    permission_file=$(curl -s https://raw.githubusercontent.com/hsspunya93/CBT/main/ip)
...
echo -e "${GREEN}Melanjutkan proses...${NC}"
sleep 2
...
curl -sS "ipinfo.io/org?token=7a814b6263b02c" > /root/julak/.isp
curl "ipinfo.io/city?token=7a814b6263b02c" > /root/julak/.city
...
wget https://raw.githubusercontent.com/hsspunya93/CBT/main/TOOLS/tools.sh -O tools.sh &> /dev/null
chmod +x tools.sh
bash tools.sh
start=$(date +%s)
...
cd
clear
wget https://raw.githubusercontent.com/hsspunya93/CBT/main/TOOLS/limit.sh -O limit.sh && chmod +x limit.sh && ./limit.sh
clear

# --- Fungsi Instalasi Modul ---
res3() {
    echo -e "${GREEN}    Memulai instalasi SSH WS / OpenVPN...${NC}"
    wget https://raw.githubusercontent.com/hsspunya93/CBT/main/SYSTEM/ssh-vpn.sh -O ssh-vpn.sh
    chmod +x ssh-vpn.sh
    ./ssh-vpn.sh
...
res4() {
    ...
    wget https://raw.githubusercontent.com/hsspunya93/CBT/main/SYSTEM/ins-xray.sh -O ins-xray.sh
    chmod +x ins-xray.sh
    ./ins-xray.sh
    clear
}
...
res5() {
    ...
    wget https://raw.githubusercontent.com/hsspunya93/CBT/main/WEBSOCKET/insshws.sh -O insshws.sh
    chmod +x insshws.sh
    ./insshws.sh
    clear
}
...
res6() {
    ...
    wget https://raw.githubusercontent.com/hsspunya93/CBT/main/SYSTEM/set-br.sh -O set-br.sh
    chmod +x set-br.sh
    ./set-br.sh
    clear
}
...
res7() {
    ...
    wget https://raw.githubusercontent.com/hsspunya93/CBT/main/WEBSOCKET/ohp.sh -O ohp.sh
    chmod +x ohp.sh
    ./ohp.sh
    clear
}
...
res8() {
    ...
    wget https://raw.githubusercontent.com/hsspunya93/CBT/main/config/up.sh -O up.sh
    chmod +x up.sh
    ./up.sh
    clear
}
...
res9() {
    ...
    wget https://raw.githubusercontent.com/hsspunya93/CBT/main/SYSTEM/slowdns.sh -O slowdns.sh
    chmod +x slowdns.sh
    ./slowdns.sh
    clear
}
...
res10() {
    ...
    wget https://raw.githubusercontent.com/hsspunya93/CBT/main/SYSTEM/udp-custom.sh -O udp-custom.sh
...
function JULAKINSTALL(){
 ...
 echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
    echo -e "${BIBlue}│ ${BGCOLOR} PANTAU PEMAKAIANA KUOTA           ${NC}${BIBlue} │${NC}"
    echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
    res13
}
...
serverV=$( curl -sS https://raw.githubusercontent.com/hsspunya93/CBT/main/TOOLS/versi )
...
echo -e "\e[1;31m⚠️ Reboot dulu sayangku \e[0m"
echo -e "❏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━❏"
